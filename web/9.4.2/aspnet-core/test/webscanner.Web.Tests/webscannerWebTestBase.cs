...
{
    public abstract class webscannerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static webscannerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(webscannerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<webscannerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<webscannerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<webscannerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<webscannerDbContext, Task<T>> func)
        {
            T result;
